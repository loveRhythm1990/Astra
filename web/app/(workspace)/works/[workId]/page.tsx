...
export default async function WorkPage({
  ...
  try {
    ...
    const [
      ...
      runtime.sdk.getWorkBranchInteractions(workId, branchId),
    ]);
    ...
    return (
      <WorkOverviewPage
        ...
        initialInteractions={readOrThrow<WorkBranchInteractionPageV1>(interactionsResult)}
      />
    );
  } catch (error) {
