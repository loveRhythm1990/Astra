...
impl Language {
    fn from_token(lang: &str) -> Option<Self> {
        match lang.to_lowercase().as_str() {
            ...
            "java" => Some(Self::Java),
            "c" | "h" | "cc" | "cpp" | "cxx" | "hpp" | "c++" | "csharp" | "c#" => Some(Self::CLike),
    ...
    fn slash_starts_comment(self) -> bool {
        matches!(
            self,
            Self::Rust | Self::JavaScript | Self::TypeScript | Self::Go | Self::Java | Self::CLike
        )
    }
    ...
    fn allows_backtick_strings(self) -> bool {
        matches!(
            self,
            Self::JavaScript | Self::TypeScript | Self::Go | Self::Shell
        )
    }
}
